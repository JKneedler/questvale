...
import 'package:questvale/cubits/todo_tab/todos_overview/combat_status_card.dart';
                ...
                child: BlocBuilder<TodosOverviewCubit, TodosOverviewState>(
                  ...
                  return QvFadingScrollable(
                    child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: visibleTodos.length + 1,
                        padding: const EdgeInsets.only(
                            left: 6, right: 6, top: 10, bottom: 10),
                        itemBuilder: (context, index) {
                          if (index == 0) {
                            return const CombatStatusCard();
                          }
                          final todo = visibleTodos[index - 1];
