      ...
      child: QvMetalCornerBorder(
        ...
        child: Column(
          children: [
            ...
            Text('Damage: ${((skill.data.damageEffect?.valueAtLevel(skill.level) ?? 0) * playerCombatStats.attackPowerFor(skill.data.damageEffect?.damageType ?? SkillDamageType.physical)).toStringAsFixed(0)}'),
