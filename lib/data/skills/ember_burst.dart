...
class EmberBurst extends BaseActiveSkill {
  ...
  // valid, if wasteful, outcome — Tier 1 has no minimum-mote require-gate,
  // that's a Tier 2+ concept). Damage scales linearly with that count; no
  // separate resource-spend mechanic — this still just costs the skill's
  // own AP/cooldown.
  @override
  Future<void> execute(
    ...
    final multiplier = (data.damageEffect?.valueAtLevel(level) ?? 0) *
        context.moteResult.motesConsumed;
